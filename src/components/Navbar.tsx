        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-[11px] sm:text-xs">
            ...
            <button
              ...
              className="flex items-center gap-1 text-[#f3e5ab] hover:text-[#d4af37] bg-white/10 hover:bg-white/15 px-2 py-0.5 rounded-md transition-colors cursor-pointer text-[11px] font-bold border border-[#d4af37]/30"
              title="Folheto para Impressão da ACEDEP (A4 & PDF)"
            >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Imprimir Folheto Button - Visible on all devices */}
            <button
              id="btn-imprimir-folheto-nav"
              onClick={() => onOpenFlyerModal ? onOpenFlyerModal() : handleNavClick('folheto')}
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 rounded-xl text-xs font-bold text-[#f3e5ab] hover:text-white bg-[#0f284a] hover:bg-[#163866] border border-[#d4af37]/40 hover:border-[#d4af37] transition-all cursor-pointer shadow-sm"
              title="Folheto de Divulgação para Impressão (A4 & PDF)"
            >
              <Printer className="w-4 h-4 text-[#d4af37]" />
              <span className="hidden sm:inline">Folheto A4</span>
              <span className="sm:hidden text-[10px]">A4</span>
            </button>
